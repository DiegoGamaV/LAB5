...
public class Aposta {
	...
	/**
	 * Constr�i uma Aposta com o nome do apostador, valor e previsão especificados.
	...
	/**
	 * Método de checagem que avalia se os valores passados são válido. Os únicos
	 * valores válido para previsao são 'VAI ACONTECER' e 'N VAI ACONTECER'. As
	 ...
	 *                se quaisquer destes casos acontecerem:
	 *                <nl>
	 *                <i> Valor de previsao é composto apenas de espa�os vazios.
	 *                </i> <i> Valor de apostador é composto apenas de espa�os
	 *                vazios. </i>
	 *                </nl>
	 * @exception NullPointerException
	 *                se quaisquer destes casos acontecerem:
